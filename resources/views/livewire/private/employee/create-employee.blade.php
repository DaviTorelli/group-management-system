<flux:main container>
  <flux:heading size="xl" level="1">Criar colaborador</flux:heading>
  <flux:subheading size="lg" class="mb-6">Insira um colaborador no seu sistema. Ao finalizar, clique em <strong>salvar</strong>.</flux:subheading>
  ...
  <form wire:submit.prevent="store" class="flex flex-col w-full gap-6 pt-4">
    ...
    <flux:select
      ...
      <option value="{{ $unit['id'] }}">{{ $unit['legal_name'] }}</option>
      @endforeach
    </flux:select>

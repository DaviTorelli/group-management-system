<flux:main container>
  <flux:heading size="xl" level="1">Colaboradores</flux:heading>
  <flux:subheading size="lg" class="mb-6">Veja todos os colaboradores cadastrados em seu sistema.</flux:subheading>
  ...
  <div class="container pt-4">
    <div class="overflow-hidden bg-white rounded-lg shadow-md dark:bg-neutral-900">
      <div class="flex items-center justify-end p-4">
        <a class="px-4 py-2 font-bold text-white rounded bg-lime-600 hover:bg-lime-700" href="{{ route('employees.create') }}">
      ...
      <table class="w-full text-left border-collapse">
        <thead>
          <tr class="text-sm leading-normal text-gray-600 bg-gray-100 dark:bg-gray-700 dark:text-gray-300">
            ...
            <th class="px-6 py-3 cursor-pointer" wire:click="sort('email')">
              <span class="flex flex-row items-center gap-1">
                E-mail
                <flux:icon.arrows-up-down variant="micro" />
              </span>
            </th>
            <th class="px-6 py-3 cursor-pointer" wire:click="sort('cpf')">
              <span class="flex flex-row items-center gap-1">
                CPF
                <flux:icon.arrows-up-down variant="micro" />
              </span>
        ...
        <tbody class="text-sm text-gray-700 divide-y divide-gray-200 dark:text-gray-300 dark:divide-gray-600">
          ...
          <tr class="hover:bg-gray-50 dark:hover:bg-gray-600" key="{{ $employee->id }}">
          ...
          <flux:modal :name="'delete-employee-'.$employee->id" class="min-w-[22rem] space-y-6">
            <div>
              <flux:heading size="lg">Deletar colaborador?</flux:heading>
            ...
            <div class="flex gap-2">
              ...
              <flux:button wire:click="destroy({{ $employee->id }})" variant="danger">Excluir</flux:button>
            </div>
          </flux:modal>
          @endforeach
        </tbody>

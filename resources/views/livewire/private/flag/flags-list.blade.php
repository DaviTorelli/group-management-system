        ...
        <div class="flex gap-2">
          <flux:input
            ...
            <x-slot name="iconTrailing">
              <flux:button size="sm" variant="filled" icon="magnifying-glass" class="-mr-1" wire:click="searchFlags" />
            </x-slot>
          </flux:input>
        </div>
        <flux:button variant="primary" icon="plus" href="{{ route('flags.create') }}" />
      </div>

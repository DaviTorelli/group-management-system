<flux:main container>
  <flux:heading size="xl" level="1">Criar bandeira</flux:heading>
  <flux:subheading size="lg" class="mb-6">Insira uma bandeira no seu sistema. Ao finalizar, clique em <strong>salvar</strong>.</flux:subheading>

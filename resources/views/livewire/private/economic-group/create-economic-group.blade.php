<flux:main container>
  <flux:heading size="xl" level="1">Criar grupo econômico</flux:heading>
  <flux:subheading size="lg" class="mb-6">Insira um grupo econômico no seu sistema. Ao finalizar, clique em <strong>salvar</strong>.</flux:subheading>

<flux:main container>
  <flux:heading size="xl" level="1">Editar grupo econômico</flux:heading>
  <flux:subheading size="lg" class="mb-6">Faça alterações no grupo econômico <strong>"{{ $this->name }}"</strong>. Ao finalizar, clique em <strong>atualizar</strong>.</flux:subheading>
